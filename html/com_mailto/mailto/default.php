...
<div id="mailto-window">
	...
	<form action="<?php echo JURI::base() ?>index.php" id="mailtoForm" method="post" class="form-horizontal">
		...
		<div class="formelm control-group">
			<label for="sender_field" class="control-label">
		...
		<div class="formelm control-group">
			<label for="from_field" class="control-label">
		...
		<div class="form-actions">
			<button class="button btn btn-primary" onclick="return Joomla.submitbutton('send');">
