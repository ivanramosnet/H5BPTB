	...
	<?php foreach ($this->children[$this->category->id] as $id => $child) : ?>
		...
		<div<?php echo $class; ?>>
			...
			<h3 class="page-header item-title"><a href="<?php echo JRoute::_(ContentHelperRoute::getCategoryRoute($child->id));?>">
				...
				<?php if (count($child->getChildren()) > 0) : ?>
					<a data-target="#category-<?php echo $child->id;?>" data-toggle="collapse" data-toggle="button" class="btn btn-default btn-xs pull-right"><span class="glyphicon glyphicon-plus"></span></a>
				<?php endif;?>
			<?php endif;?>
			</h3>
