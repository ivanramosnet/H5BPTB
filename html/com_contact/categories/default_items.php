			...
			<?php $class = ''; ?>
				<h3 class="page-header item-title">
					...
					<?php if (count($item->getChildren()) > 0) : ?>
						<button type="button"  data-target="#category-<?php echo $item->id;?>" data-toggle="collapse" class="btn btn-default btn-xs pull-right"><span class="glyphicon glyphicon-plus"></span></button>
					<?php endif;?>
				</h3>
